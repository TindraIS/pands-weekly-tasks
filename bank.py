...
# print the result to the console ensuring its consistency and readability: 
    # A. format it with the euro symbol with an f-string, which allows Python expressions to be embedded inside string constants
